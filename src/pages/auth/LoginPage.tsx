...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    setIsLoading(true);
    // Simulate auth — will be replaced by Convex
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 sm:px-12 bg-white">
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-neutral-200 bg-white hover:bg-neutral-50 text-sm font-semibold text-neutral-800 transition-all cursor-pointer active:scale-[0.98]">
