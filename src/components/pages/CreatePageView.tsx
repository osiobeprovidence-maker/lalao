...
export const CreatePageView: React.FC<{ embedded?: boolean }> = ({ embedded = false }) => {
  const {
    location,
    createPage,
    createFlowType,
  ...
  const shellClass = embedded
    ...
    : 'absolute inset-0 z-40 bg-white flex flex-col min-h-full overflow-y-auto animate-in fade-in slide-in-from-right-4 duration-250';
